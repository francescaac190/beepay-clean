  ...
  Future<void> _showErrorDialog(String title, String msg) async {
    await showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content:
            SingleChildScrollView(child: Text(msg, style: regular(gris7, 14))),
        actions: [
          TextButton(
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (res.statusCode >= 200 && res.statusCode < 300) {
        ...
        final estado = body is Map
            ? (body['estado'] ?? body['status'] ?? res.statusCode)
            : res.statusCode;
        final message = body is Map
            ? (body['message'] ?? body['mensaje'] ?? 'Operación exitosa')
            : 'Operación exitosa';
                  ...
                  child: ListView(
                    ...
                    children: [
                      Text('Información de Pasajero',
                          style: bold(blackBeePay, 16)),
                      const Divider(
                          thickness: 1, height: 20, color: Colors.black),

                      // Nombre
                      Text('Ingresá tu nombre de pila:',
                      ...
                      Container(
                        ...
                        child: DropdownButton<String>(
                          ...
                          style: regular(gris6, 14),
                          onChanged: (v) => setState(() => idDocumento =
                              (v == 'Carnet de identidad') ? 1 : 2),
                        ),
                      ),
                      const SizedBox(height: 10),
                      ...
                      TextFormField(
                        ...
                        keyboardType: TextInputType
                            .text, // algunos pasaportes tienen letras
